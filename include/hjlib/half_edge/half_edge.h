...
public: // types
  ...
  public:
    ...
    typedef half_edge_mesh_t<ICon, IP> mesh_type;
...
public: // basic operations
  ...
  //add is not allow to use for high level operations since it doesn't
  //assure the adjacency of a halfedge and its opposite
  ...
  typename edges_t::const_iterator add_edge(const edge_t &e)
  {
    //edges_.add()
  }
